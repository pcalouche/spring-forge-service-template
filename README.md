...
Spring Elixir provides a status endpoint, standard controller advice exception handling, and Swagger documentation configured.  Running this application and
going to [localhost:8080/swagger-ui.html](localhost:8080/swagger-ui.html) will display the Swagger documentation.  From there you'll see two endpoints:
